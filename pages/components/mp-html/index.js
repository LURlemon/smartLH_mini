...
var t = require("./parser"),
  n = [require("./highlight/index.js"), require("./style/index.js"), require("./editable/index.js")];
Component({
  data: {
    nodes: []
  },
  properties: {
    editable: {
      type: Boolean,
      observer: function (e) {
        this.data.content ? this.setContent(e ? this.data.content : this.getContent()) : e && this.setData({
          nodes: [{
            name: "p",
            attrs: {},
            children: [{
  ...
  methods: {
    _containTap: function () {
      this._lock || this.data.slider || (this._edit = void 0, this._maskTap())
    },
    _tooltipTap: function (e) {
      this._tooltipcb(e.currentTarget.dataset.i), this.setData({
        tooltip: null
      })
    },
    ...
    setContent: function (e, n) {
      ...
      clearInterval(this._timer), this._timer = setInterval(function () {
        i.getRect().then(function (e) {
          e.height === l && (i.triggerEvent("ready", e), clearInterval(i._timer)), l = e.height
        }).catch(function () {})
      }, 350)
    },
    _hook: function (e) {
